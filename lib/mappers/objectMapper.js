...
class ObjectMapper extends Transform {
    constructor(options) {
        ...
        this._baseURIObject = 'http://' + config.eventstream.hostname + port + '/' + path + options.adlibDatabase;
    ...
    _transform(object, encoding, done) {
        ...
        try {
            ...
            mappedObject["dcterms:isVersionOf"] = this._baseURICulturize + options.adlibDatabase + '/id/' + input["@attributes"].priref;
